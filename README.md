...
- `/send_delivery_info` — отправить своему получателю QR/штрих-код/трек/ссылку (текст и/или картинку).
- `/admin_menu` — меню администратора (доступно только ADMIN_ID).
- `/list_participants` — список участников.
- `/delivery_logs` — (админ) последние отправки QR/трек-данных между участниками.
- `/delivery_logs_user telegram_id` — (админ) логи отправок по участнику.
